...
export default function ContactUs() {
  ...
  return (
    <AuroraBackground>
        ...
        <div className='mt-12'>
            <h1 className='text-3xl font-bold mb-10 text-white'>Contact Me</h1>

            <h1 className='text-xl  mb-2 text-green-400 font-medium'>Hire me on upwork</h1>
            ...
            <button className="my-10 px-4 py-2 rounded-md text-black text-center relative overflow-hidden bg-white  flex justify-center group/modal-btn">
        ...
        <div className="flex items-start justify-start h-[35rem] my-28 ">
      <FloatingDock
