...
export default function Testimonials() {
  return (
    <div className="h-[40rem] rounded-md flex flex-col antialiased bg-black bg-grid-white/[0.05] items-center justify-center relative overflow-hidden">
        ...
        <p className="text-2xl text-gray-400 max-w-3xl text-center mt-5 mb-12 ">Throughout my career, I have received valuable feedback from my clients. Here are some highlights they have shared.</p>
      <InfiniteMovingCards
        items={testimonials}
        direction="right"
        speed="slow"
